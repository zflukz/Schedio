        ...
        <section className="bg-white border border-[#ECECEC] rounded-[28px] shadow-[0px_24px_48px_rgba(16,24,40,0.06)] p-6 sm:p-10 mt-10">
          ...
          <div className="mt-6 space-y-3 text-[15px] text-[#525252]">
            <div className="flex items-center gap-3">
              <CalendarDaysIcon className="h-5 w-5 text-[#2AA5B9]" /> {data.date}
            </div>
            <div className="flex items-center gap-3">
              <ClockIcon className="h-5 w-5 text-[#2AA5B9]" /> {data.time}
            </div>
            <div className="flex items-center gap-3">
              <MapPinIcon className="h-5 w-5 text-[#2AA5B9]" /> {data.location}
            </div>
            <div className="flex items-center gap-3">
              <UsersIcon className="h-5 w-5 text-[#2AA5B9]" /> {data.totalseats || 50} Seats <span className="text-[#7B7B7B]">Walk-in available</span>
            </div>
            <div className="flex items-center gap-3">
              <PhoneIcon className="h-5 w-5 text-[#2AA5B9]" /> {data.contactName || "Contact"} | {data.contactPhone || "-"}
            </div>
            <div className="flex items-center gap-3">
              <BellAlertIcon className="h-5 w-5 text-[#2AA5B9]" /> Reminder 60 minutes before event starts.
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-10 flex gap-3 justify-center">
                ...
                <button className="px-[80px] py-2 rounded-[10px] bg-[#FFD6D6] text-[#D14343] font-semibold" onClick={() => navigate(-1)}>
                Reject
              </button>
            </div>
